...
export default function VerificationLayout({
  ...
  return (
    <div className="relative bg-linear-to-br from-success/10 via-base-100 to-warning/10 w-full min-h-screen overflow-hidden">
      ...
      <div className="z-10 relative flex justify-center items-center p-4 sm:p-6 w-full min-h-screen">
        <motion.div
        ...
        >
          ...
          <div className="bg-base-100/70 shadow-elevated backdrop-blur-xl border border-base-300/60 card">
            <div className="p-6 sm:p-8 card-body">
              {isPending ? (
                <div className="bg-base-100 shadow-sm border border-base-300 overflow-hidden card">
                  <div className="space-y-5 p-6 sm:p-8 text-center card-body">
                    <div className="flex justify-center items-center bg-warning/10 mx-auto rounded-full w-20 h-20">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="mx-auto max-w-md text-muted-foreground text-sm">
                        Your documents have been received and an admin will
                        review them shortly. Reviews are typically completed
                        within 24–48 hours.
                      </p>
                    </div>
                    <div className="flex justify-center items-center gap-2 text-sm">
                      <span className="gap-1 px-2 badge badge-warning">
